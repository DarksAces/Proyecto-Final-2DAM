...
class SettingsService {
  ...
  static const _tutorialShown = 'tutorialShown';
  ...
  Future<bool> isTutorialShown(String userId) async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getBool('${_tutorialShown}_$userId') ?? false;
  }

  Future<void> setTutorialShown(String userId) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('${_tutorialShown}_$userId', true);
  }
}