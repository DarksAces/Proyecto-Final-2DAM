                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _ProductCard(
                        title: data['title'] ?? 'Producto Aura',
    ...
    return Column(
      children: [
        Container(
          ...
          child: Icon(icon,
              color: isLight ? AppTheme.auraRed : Colors.grey.shade600,
              size: 24),
        ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: isRedButton ? AppTheme.auraRed : Colors.white,
                side: isRedButton
                    ? null
                    : const BorderSide(color: AppTheme.auraRed),
              ...
              child: Text(buttonText,
                  style: TextStyle(
                      color: isRedButton ? Colors.white : AppTheme.auraRed,
                      fontSize: 12,
                      fontWeight: FontWeight.bold)),
            ),
          )
