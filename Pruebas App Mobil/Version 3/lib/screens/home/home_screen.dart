              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon:
                        const Icon(Icons.search, color: AppTheme.auraRed),
                    ...
                    focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: const BorderSide(
                            color: AppTheme.auraRed, width: 1)),
                  ),
                ),
...
class _FilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChoiceChip(
      ...
      selectedColor: AppTheme.auraRed.withValues(alpha: 0.1),
      backgroundColor: Colors.grey.shade50,
      labelStyle: TextStyle(
          color: isSelected ? AppTheme.auraRed : Colors.black87,
