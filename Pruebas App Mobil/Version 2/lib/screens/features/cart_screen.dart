              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: AppTheme.joviRed.withAlpha(50))),
                  child: Row(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(4),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 5,
                        shadowColor: AppTheme.joviRed.withAlpha(100),
                      ),
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Icon(icon,
            ...
            color: isRed ? AppTheme.joviRed : Colors.grey.shade600),
      ),
    );
  }
}
