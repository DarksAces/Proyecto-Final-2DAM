                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text("Pack Explorador AR + Merch Jovi",
    ...
    return Column(
      children: [
        Container(
          padding: const EdgeInsets.all(8),
          decoration: BoxDecoration(
            color: isActive ? AppTheme.joviRed : Colors.grey.shade100,
            shape: BoxShape.circle,
          ),
          child: Icon(icon,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
        ...
        color: isActive ? AppTheme.joviRed : Colors.grey.shade200,
      ),
    );
  }
}
